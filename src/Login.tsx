    ...
    <div className="min-h-screen bg-gradient-to-br from-green-600 via-green-700 to-green-800 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        <div className="px-8 pt-8 pb-6 text-center">
          <img 
            src="https://images.pexels.com/photos/5462964/pexels-photo-5462964.jpeg?auto=compress&cs=tinysrgb&w=100"
            alt="PACS Logo" 
            className="w-20 h-20 rounded-full mx-auto mb-4 object-cover shadow-lg"
          />
          <h2 className="text-3xl font-bold text-gray-800 mb-2">PACS Portal</h2>
          <p className="text-gray-600">Primary Agricultural Credit Society</p>
        </div>
